...
data = read_excel("~/Desktop/CRS/ancova/data/25-VanLeijsen/VanLeijstudyNo25DATA.xlsx")
names(data)
```
...
# We analyzed associations between plasma Aβ and SVD markers by ANCOVA adjusted for age, sex, and hypertension. (plasmaAB is the first DV)
ancovaModel<-aov(AB38 ~ mb_presence_b + lac_presence_b + age, data = data)
