...
We'd like to contact you to kindly request data from one of your recent publications.\n\n
...
# Inspect mail
```{r}
attach_connect_email(email = emails[[31]])
```
...
smtp_send(
  email =  emails[[i]],
  subject = paste0("Request to share data (study no. ", i, ")"),
