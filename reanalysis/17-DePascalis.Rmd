...
data = read_excel("../dataPrimaryStudies/17-DePascalis/17-DePascalis-1.xlsx", skip = 4)
names(data)
dim(data)
# correcting typo
...
contrasts(data$IntensityIV) <-contr.helmert(5)
contrasts(data$EmotionIV) <-contr.helmert(3)
contrasts(data$Electrode) <-contr.helmert(3)
