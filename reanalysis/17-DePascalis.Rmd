...
---
The following reanalysis comes from the paper at doi.org : 10.1038/srep41588
...
```{r, include = TRUE, echo = FALSE, eval = TRUE, tidy = TRUE}
data = read_excel("../data/17-DePascalis/BIS_cov_N1-P2peak_amplitude_r.xlsx", skip = 4)
names(data)
dim(data)
# correcting typo
...
ancovaModel<-aov(DV ~ COV + EmotionIV, data = data)
lm_ancova <- lm(DV ~ COV + EmotionIV + IntensityIV + ElectrodeIV, df.residual = 76, data = data)
