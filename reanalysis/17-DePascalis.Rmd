...
# order levels within IVs only with Intensity 
data$IntensityIV <- factor(data$IntensityIV, levels = c("One", "Two", "Three", "Four", "Five"), ordered = TRUE)
# data$EmotionIV <- factor(data$EmotionIV, levels = c("Neutral", "Negative", "Positive"), ordered = TRUE)
# data$ElectrodeIV <- factor(data$ElectrodeIV, levels = c("ElectrodeOne", "ElectrodeTwo", "ElectrodeThree"), ordered = TRUE)
...
tab.dv
tab.dv[,1] = c("IntensityIV neutral", "EmotionIV", "ElectrodeIV", "IntensityIV", "EmotionIV", "ElectrodeIV", "IntensityIV", "EmotionIV", "ElectrodeIV", "IntensityIV", "EmotionIV")
...
# data %>%
#   group_by(IntensityIV, EmotionIV, ElectrodeIV) %>%
...
summary(ancovaModel)
summary(Anova(ancovaModel, idata=intra, idesign=~EmotionIV*IntensityIV*ElectrodeIV, multivariate=FALSE, univariate=TRUE))
