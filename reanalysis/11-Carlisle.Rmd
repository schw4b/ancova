...
# The author did not run a classic ancova with IV + COV, but instea an interaction IV*COV similar ro testing
# the homogenity of slope assumption
...
* The assumption is not met in this paper, however, the authors' goal was exactly to investigate the different slopes across species (Table 2).
```{r}
...
* Assumptions hold. Homogenity of regression slopes was part of the research questions.
* ANCOVA used with interactions term for species and whole brain volume, not to regress covariate
* Log transform of IV and CV was successful
* Lots of models tested, no correction for multiplicity
