...
* Dependant variable: Pain intensity (PI) (average across follow-ups, AVP_30)
...
* Covariate: basline PI
* Design: 1-way ANCOVA with group as IV and baselie PI as covariate
...
# Descriptives
## Dependant variable
Number of samples and mean (SD) in levels of the independant variables.
```{r}
...
```{r}
means.adj = effect("tratt", fit.ancova, se=TRUE)
MD = means.adj$fit[1] - means.adj$fit[2] 
# SE is smaller as covarate reduced noise
