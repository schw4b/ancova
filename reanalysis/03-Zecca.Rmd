...
* Non-inferiority intervention study, ANVOVA is used to calculate adjusted means for the two groups (corrected for baseline pain)
...
* One assumptions not met, baseline pain (CV) not independent from treatment groups (IV)
