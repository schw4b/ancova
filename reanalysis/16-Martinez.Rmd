...
# Reference
Martinez et al. (2018). Convergent evolution of an extreme dietary specialisation, the olfactory system of worm-eating rodents
rodents. *Scientific Reports*, 17806(8), 351–359. https://doi.org/10.1038/s41598-018-35827-0
...
```{r}
# PATH = file.path(path.expand("~"), "CRS", "ancova")
...
data = read.csv("../dataPrimaryStudies/16-Martinez/testancova.csv")
head(data, 6)
unique(data$DIET)
...
data$Group.factor[data$Group == 0] = "INSEC"
data$Group.factor[data$Group == 1] = "OMNI"
data$Group.factor[data$Group == 2] = "WORM"
