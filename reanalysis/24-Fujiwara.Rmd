...
rownames(tab.IV) = c("original Study", "reanalysis type I SS", "reanalysis type II SS")
print(t(tab.IV))
```
...
* Homogeneity of regression slopes was met for group and emotion, but not across levels of ambiguity.
