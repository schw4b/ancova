...
* The independant variables microbleeds and lacunes with two levels each
* Covariate: age
...
data$sex.factor[data$sex == 2] = "0"
data$sex.factor[data$sex.factor == 0] = "male"
...
```{r}
sprintf("%.1f (%.1f)", mean(data$AB38[data$mb_presence_b == 1]), sd(data$AB38[data$mb_presence_b == 1]))

sprintf("%.1f (%.1f)", mean(data$AB38[data$mb_presence_b == 0]), sd(data$AB38[data$mb_presence_b == 0]))

sprintf("%.1f (%.1f)", mean(data$AB38[data$lac_presence_b == 1]), sd(data$AB38[data$mb_presence_b == 1]))

sprintf("%.1f (%.1f)", mean(data$AB38[data$lac_presence_b == 0]), sd(data$AB38[data$lac_presence_b == 0]))
```
...
#contrasts(data$mb_presence_b) = contr.helmert(3) 
#contrasts(data$lac_presence_b) = contr.helmert(3) 
